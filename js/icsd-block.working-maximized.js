...
( function() {
    ...
    function icsd_select ( props ) {
        return el(
            SelectControl,
            {
                ...
                value       : props.attributes.icsd,
                // onChange    : props.setAttributes( { icsd } )
                onChange    : function ( val ) {
                    props.setAttributes( props.attributes.icsd = val )
                }
            }
        );
    }
    ...
    function get_posts() {
        ...
        myData = jQuery.when( jQuery.ajax({
